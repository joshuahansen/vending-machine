...
void addToList(struct ppd_list *item_list, struct ppd_stock *newStock);
...
void sortList(struct ppd_system *system);
void resetStockLevels(struct ppd_system *system);
void generateID(struct ppd_system *system, char *itemID);
